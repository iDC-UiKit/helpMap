...
//        tf.backgroundColor = #colorLiteral(red: 0.2, green: 0.2, blue: 0.2, alpha: 1)
    ...
    lazy var loginButton: UIButton = {
        ...
        //button.addTarget(self, action: #selector(loginButtonTapped), for: .touchUpInside) // 요건 무조건 뷰컨트롤러에 들어가야해서 주석처리했음.
        return button
    }()
    // MARK: - 회원가입 버튼
    ...
    private lazy var stackView: UIStackView = {
        let stview = UIStackView(arrangedSubviews: [emailTextFieldView, passwordTextFieldView, loginButton, signupButton])
        stview.spacing = 18
